...
var callBackGetSuccess = function (data) {
    ...
    element.innerHTML = "La temperature actuelle a " + data.name + " est de "  + data.main.temp + " \u00b0C" + ", et la pression est de " + data.main.pressure + " Hpa<br>" + "Les conditions actuelles sont: " + data.weather[0].description + ", la vitesse du vent est de " + Math.floor(data.wind.speed*3.6) + " km/h"
...
var callBackPrevision = function (data) {
    ...
    element.innerHTML = "Demain matin, a " + data.city.name+ ", il fera: " + data.list[7].main.temp + "\u00b0C," + " la pression sera d'environ " + data.list[7].main.pressure + " Hpa<br>" + "Les conditions seront: " + data.list[7].weather[0].description + ", la vitesse du vent sera de " + Math.floor(data.list[7].wind.speed*3.6) + " km/h"
    ...
    data.list.forEach(element => {
        heures.push(element.dt_txt)
        vent.push(Math.floor(element.wind.speed*3.6))
        }
    );   
